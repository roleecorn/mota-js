...
previewBlock : true
allIds : ['EvalString_1']
default : ["弱智","default","","","","",0,false,"欢迎使用事件编辑器(双击方块可直接预览)"]
var title='';
if (EvalString_0==''){
...
previewBlock : true
allIds : ['EvalString_1']
default : ["弱智","default","","","","",0,"欢迎使用事件编辑器(双击方块可直接预览)",null]
var title='';
if (EvalString_0==''){
    if (EvalString_1=='' )title='';
    else title='\\t['+EvalString_1+']';
...
doubleclicktext : EvalString_Multi_0
allIds : ['EvalString_1']
default : ["弱智","default","",3000,"用户无法跳过自动剧情文本，大段剧情文本请添加“是否跳过剧情”的提示"]
var title='';
if (EvalString_0==''){
    if (EvalString_1=='' )title='';
    else title='\\t['+EvalString_1+']';
